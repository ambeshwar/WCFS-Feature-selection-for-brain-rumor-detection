...
public class Graphh1 extends ApplicationFrame {
     ...
     */
    public Graphh1(final String title) {
    ...
    private CategoryDataset createDataset() {
		...
		{
			String s1;
			BufferedReader br1=new BufferedReader(new FileReader("Performance\\DDR.txt"));
    ...
    private JFreeChart createChart(final CategoryDataset dataset) {
        ...
        final JFreeChart chart = ChartFactory.createBarChart3D(
            "Number of Patient (N)  Vs Disease Diagnosis Rate (%)  ",         // chart title
            "Number of Patient (N) ",               // domain axis label
            "Disease Diagnosis Rate (%) ",                  // range axis label
            dataset,                  // data
    ...
    public static void main(final String[] args) {
        ...
        final Graphh1 graph = new Graphh1("Number of Patient (N) Vs  Disease Diagnosis Rate (%) ");
        graph.pack();
