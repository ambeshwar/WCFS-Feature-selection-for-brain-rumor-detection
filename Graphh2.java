...
public class Graphh2 extends ApplicationFrame {
     ...
     */
    public Graphh2(final String title) {
    ...
    private CategoryDataset createDataset() {
		...
		{
			String s1;
			BufferedReader br1=new BufferedReader(new FileReader("Performance\\DDT.txt"));
    ...
    private JFreeChart createChart(final CategoryDataset dataset) {
        ...
        final JFreeChart chart = ChartFactory.createBarChart3D(
            "Number of Patient (N)  Vs Disease Diagnosis Time (ms)  ",         // chart title
            "Number of Patient (N) ",               // domain axis label
            "Disease Diagnosis Time (ms) ",                  // range axis label
            dataset,                  // data
    ...
    public static void main(final String[] args) {
        ...
        final Graphh2 graph = new Graphh2("Number of Patient (N) Vs  Disease Diagnosis Time (ms) ");
        graph.pack();
